...
// export const baseURLStats = window.location.protocol + '//vms.cstcloud.cn/api'
export const baseURLStats = window.location.protocol + '//servicebackend.cstcloud.cn/api'
