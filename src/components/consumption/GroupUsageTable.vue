...
const columns = computed(() => [
  ...
  { name: 'vo_id', label: (() => tc('group'))(), align: 'center' },
  ...
  { name: 'total_trade_amount', label: (() => tc('actualDeductionAmount'))(), align: 'center' }
])
      ...
      >
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td class="no-padding" key="configuration" :props="props">{{props.row.vcpus + ' ' + tc('core') + ' ' + Math.round(props.row.ram / 1024) + 'GB' }}</q-td>
