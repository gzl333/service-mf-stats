  ...
  <div class="ServiceList">
    ...
    <div class="q-px-lg q-mt-md">
      ...
      <q-tab-panels v-model="activeItem" animated>
        <q-tab-panel name="id" class="no-padding">
          <q-table
            flat
            id="userTable"
        ...
        <q-tab-panel name="group" class="no-padding">
          <q-table
            flat
            id="groupTable"
            table-header-class="bg-grey-1 text-grey"
        ...
        <q-tab-panel name="uuid" class="no-padding">
          <q-separator/>
          <q-table
            flat
            id="uuTable"
        ...
        <q-tab-panel name="node" class="no-padding">
          <q-table
            flat
            id="nodeTable"
            table-header-class="bg-grey-1 text-grey"
