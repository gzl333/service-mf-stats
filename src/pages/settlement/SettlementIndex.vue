    ...
    <div class="column">
      <div class="row justify-center">
        <div class="content-fixed-width">
          ...
          >
            <q-tab no-caps name="history" class="q-px-none q-py-md q-mr-md" :ripple="false" label="个人云主机日结算单"
                   icon="las la-server" @click="changeTab('history')">
            </q-tab>
            <q-tab no-caps name="storage" class="q-px-none q-py-md q-mr-md" :ripple="false" label="个人对象存储日结算单"
                   icon="lab la-bitbucket" @click="changeTab('storage')">
            </q-tab>
            <q-tab no-caps name="group" class="q-px-none q-py-md q-mr-md" :ripple="false" label="项目组云主机日结算单"
