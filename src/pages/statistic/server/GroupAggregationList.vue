...
const getGroupAggregationData = async () => {
  ...
  const respGroupMetering = await stats.stats.metering.getAggregationVo({ query: query.value })
  groupTableRow.value = respGroupMetering.data.results
  paginationTable.value.count = respGroupMetering.data.count
