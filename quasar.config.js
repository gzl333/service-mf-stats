...
module.exports = configure(function (ctx) {
  return {
    ...
    build: {
      ...
      distDir: 'dist/stats', // @mimas: change quasar build dir, quasar will clean this folder each time building
      env: {
      ...
      extendWebpack (cfg) {
        cfg.output = {
          ...
          path: resolve(__dirname, 'dist/stats') // @mimas: where to put all files but index.html (which goes with the distDir setting)
        }
    ...
    pwa: {
      ...
      manifest: {
        name: 'Micro Frontend Stats',
        short_name: 'Micro Frontend Stats',
        description: '',
        display: 'standalone',
